    ...
    <main className={`${inter.className}`}>
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col">
          {/* Możesz usunąć lub zakomentować starą nawigację tutaj */}
          {/* <nav className="py-4">
            <ul className="flex justify-center space-x-8">
              {navItems.map((item) => (
                <li key={item.name}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                image: "/jan.png",
                quote:
                  "Jestem bardzo zadowolona, Pani Iza pomogła mi pozyskać dofinansowanie z PUP, ekspresowo sporządzony wniosek i ppzytywna decyzja, wszystko trwało miesiąc. Polecam",
              },
      ...
      {/* Footer */}
      <footer className="bg-darkGold text-white py-8">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col items-center">
              <a
                ...
                className="mb-4 p-2 rounded-full transition-all duration-300 hover:bg-white hover:bg-opacity-20"
              >
              ...
              <a
                ...
                className="p-2 rounded-full transition-all duration-300 hover:bg-white hover:bg-opacity-20"
              >
